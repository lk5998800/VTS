...
class SimulatorCommandTest {
  private SimulatorCommand testSimulatorCommand;
  ...
  public void setUp() {
    ...
    testSimulatorCommand = new StartCommand(simulator);
  }
  ...
  public void testExecute() {
    ...
    testSimulatorCommand.execute(sessionMock, commandFromClient);
